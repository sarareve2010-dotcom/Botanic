// Accueil clarifie : tableau de bord clair et sans formulation trompeuse.
(function(){
  window.home=function(){
    ...
    const todo=Math.max(0,c.total-detailed);
    view.innerHTML=progressBlock()+`<div class="grid">
      ...
      <section class="card span-6"><h3>État de la base</h3><p><b>${c.total}</b> entrées dans le catalogue. Pour l’instant, <b>${detailed}</b> fiches servent de modèles enrichis de départ, et <b>${todo}</b> fiches locales sont des emplacements à compléter progressivement avec des données vérifiées.</p></section>
      ...
      <section class="card span-12 warn"><b>Important :</b> Botadex est un outil d’apprentissage. Les fiches locales ne sont pas des fiches officielles : pour un rapport professionnel, vérifie toujours les noms, statuts et habitats avec INPN/TAXREF, CBN, DREAL, EUNIS/HabRef et les documents Natura 2000 locaux.</section>
    </div>`;
  };
